package
{
   ...
   // m2b golden harness — drives the SAP broadphase DIRECTLY (no world, no narrowphase)
   // with a plain b2PairCallback (PairAdded returns null). Exercises CreateProxy,
   // MoveProxy, QueryAABB, DestroyProxy and the pair manager. Dumps the quantized
   // bound arrays (value/proxyId/stabbingCount), proxy & pair counts, and query
   // results after each stage. Everything dumped is an integer => bit-exact.
