package Box2D.Collision
{
   ...
   public class b2BroadPhase
   {
      ...
      public function QuerySegment(param1:b2Segment, param2:*, param3:int, param4:Function) : int
      {
         ...
         var _loc30_:uint = 0;
         var _loc5_:Number = 1;
         var _loc6_:Number = (param1.p2.x - param1.p1.x) * this.m_quantizationFactor.x;
         var _loc7_:Number = (param1.p2.y - param1.p1.y) * this.m_quantizationFactor.y;
         ...
         var _loc10_:Number = this.m_quantizationFactor.x * (param1.p1.x - this.m_worldAABB.lowerBound.x);
         var _loc11_:Number = this.m_quantizationFactor.y * (param1.p1.y - this.m_worldAABB.lowerBound.y);
         ...
         var _loc22_:Array = [_loc20_];
         this.Query(_loc21_,_loc22_,_loc12_[0],_loc13_[0],this.m_bounds[0],2 * this.m_proxyCount,0);
         if(_loc8_ >= 0)
         {
            _loc15_ = _loc22_[0] - 1;
         }
         ...
         {
            _loc15_ = int(_loc21_[0]);
         }
         this.Query(_loc21_,_loc22_,_loc12_[1],_loc13_[1],this.m_bounds[1],2 * this.m_proxyCount,1);
         if(_loc9_ >= 0)
         {
            _loc16_ = _loc22_[0] - 1;
         }
         ...
         {
            _loc16_ = int(_loc21_[0]);
         }
         if(param4 != null)
         {
            _loc27_ = 0;
            while(_loc27_ < this.m_queryResultCount)
            {
               this.m_querySortKeys[_loc27_] = param4(this.m_proxyPool[this.m_queryResults[_loc27_]].userData);
               _loc27_++;
            }
            _loc27_ = 0;
            while(_loc27_ < this.m_queryResultCount - 1)
            {
               _loc28_ = Number(this.m_querySortKeys[_loc27_]);
               _loc29_ = Number(this.m_querySortKeys[_loc27_ + 1]);
               if(_loc28_ < 0 ? _loc29_ >= 0 : _loc28_ > _loc29_ && _loc29_ >= 0)
               {
                  this.m_querySortKeys[_loc27_ + 1] = _loc28_;
                  this.m_querySortKeys[_loc27_] = _loc29_;
                  _loc30_ = uint(this.m_queryResults[_loc27_ + 1]);
                  this.m_queryResults[_loc27_ + 1] = this.m_queryResults[_loc27_];
                  this.m_queryResults[_loc27_] = _loc30_;
                  if(--_loc27_ == -1)
                  {
                     _loc27_ = 1;
                  }
         ...
         if(_loc15_ < 0 || _loc15_ >= this.m_proxyCount * 2)
         {
            _loc23_ = false;
         }
         if(_loc16_ < 0 || _loc16_ >= this.m_proxyCount * 2)
         {
            _loc23_ = false;
         }
         if(_loc23_)
         {
            if(_loc8_ != 0)
            {
               if(_loc8_ > 0)
               {
                  if(++_loc15_ == this.m_proxyCount * 2)
                  {
                     _loc23_ = false;
                  }
               }
               ...
               _loc24_ = (this.m_bounds[0][_loc15_].value - _loc10_) / _loc6_;
            }
            if(_loc9_ != 0)
            {
               if(_loc9_ > 0)
               {
                  if(++_loc16_ == this.m_proxyCount * 2)
                  {
                     _loc23_ = false;
                  }
               }
               ...
               _loc25_ = (this.m_bounds[1][_loc16_].value - _loc11_) / _loc7_;
            }
         }
         while(_loc23_)
         {
            if(_loc9_ == 0 || _loc8_ != 0 && _loc24_ < _loc25_)
            {
               if(_loc24_ > _loc5_)
               {
                  break;
               }
               if(_loc8_ > 0 ? Boolean(this.m_bounds[0][_loc15_].IsLower()) : Boolean(this.m_bounds[0][_loc15_].IsUpper()))
               {
                  _loc17_ = uint(this.m_bounds[0][_loc15_].proxyId);
                  _loc18_ = this.m_proxyPool[_loc17_];
                  if(_loc9_ >= 0)
                  {
                     if(_loc18_.lowerBounds[1] <= _loc16_ - 1 && _loc18_.upperBounds[1] >= _loc16_)
                     {
                        if(param4 != null)
                        {
                           this.AddProxyResult(_loc17_,_loc18_,param3,param4);
                        }
                        else
                        {
                           this.m_queryResults[this.m_queryResultCount] = _loc17_;
                           ++this.m_queryResultCount;
                        }
                     }
                  }
                  else if(_loc18_.lowerBounds[1] <= _loc16_ && _loc18_.upperBounds[1] >= _loc16_ + 1)
                  {
                     if(param4 != null)
                     {
                        this.AddProxyResult(_loc17_,_loc18_,param3,param4);
               ...
               if(param4 != null && this.m_queryResultCount == param3 && this.m_queryResultCount > 0 && _loc24_ > this.m_querySortKeys[this.m_queryResultCount - 1])
               {
                  break;
               }
               if(_loc8_ > 0)
            ...
            else
            {
               ...
               if(_loc9_ > 0 ? Boolean(this.m_bounds[1][_loc16_].IsLower()) : Boolean(this.m_bounds[1][_loc16_].IsUpper()))
               {
                  _loc17_ = uint(this.m_bounds[1][_loc16_].proxyId);
                  _loc18_ = this.m_proxyPool[_loc17_];
                  if(_loc8_ >= 0)
                  {
                     if(_loc18_.lowerBounds[0] <= _loc15_ - 1 && _loc18_.upperBounds[0] >= _loc15_)
                     {
                        if(param4 != null)
                        {
                           this.AddProxyResult(_loc17_,_loc18_,param3,param4);
                  ...
                  else if(_loc18_.lowerBounds[0] <= _loc15_ && _loc18_.upperBounds[0] >= _loc15_ + 1)
                  {
                     if(param4 != null)
                     {
                        this.AddProxyResult(_loc17_,_loc18_,param3,param4);
               ...
               if(param4 != null && this.m_queryResultCount == param3 && this.m_queryResultCount > 0 && _loc25_ > this.m_querySortKeys[this.m_queryResultCount - 1])
               {
                  break;
               }
               if(_loc9_ > 0)
         ...
         var _loc26_:int = 0;
         _loc27_ = 0;
         while(_loc27_ < this.m_queryResultCount && _loc26_ < param3)
         {
            _loc18_ = this.m_proxyPool[this.m_queryResults[_loc27_]];
            param2[_loc27_] = _loc18_.userData;
            _loc27_++;
            _loc26_++;
         }
         this.m_queryResultCount = 0;
      ...
      private function ComputeBounds(param1:Array, param2:Array, param3:b2AABB) : void
      {
         ...
         param2[0] = uint(this.m_quantizationFactor.x * (_loc6_ - this.m_worldAABB.lowerBound.x)) & 0xFFFF | 1;
         param1[1] = uint(this.m_quantizationFactor.y * (_loc5_ - this.m_worldAABB.lowerBound.y)) & b2Settings.USHRT_MAX - 1;
         param2[1] = uint(this.m_quantizationFactor.y * (_loc7_ - this.m_worldAABB.lowerBound.y)) & 0xFFFF | 1;
      }
      ...
      private function AddProxyResult(param1:uint, param2:b2Proxy, param3:Number, param4:Function) : void
      {
         var _loc9_:Number = NaN;
         var _loc10_:uint = 0;
         var _loc5_:Number = param4(param2.userData);
         if(_loc5_ < 0)
         {
            return;
         }
         var _loc6_:Number = 0;
         while(_loc6_ < this.m_queryResultCount && this.m_querySortKeys[_loc6_] < _loc5_)
         {
            _loc6_++;
         }
         var _loc7_:Number = _loc5_;
         var _loc8_:uint = param1;
         this.m_queryResultCount += 1;
         if(this.m_queryResultCount > param3)
         {
            this.m_queryResultCount = param3;
         }
         while(_loc6_ < this.m_queryResultCount)
         {
            _loc9_ = Number(this.m_querySortKeys[_loc6_]);
            _loc10_ = uint(this.m_queryResults[_loc6_]);
            this.m_querySortKeys[_loc6_] = _loc7_;
            this.m_queryResults[_loc6_] = _loc8_;
            _loc7_ = _loc9_;
            _loc8_ = _loc10_;
            _loc6_++;
         }
