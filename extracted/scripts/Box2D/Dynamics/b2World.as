package Box2D.Dynamics
{
   ...
   public class b2World
   {
      ...
      public var m_raycastNormal:b2Vec2 = new b2Vec2();
      ...
      public function Raycast(param1:b2Segment, param2:Array, param3:int, param4:*) : int
      {
         var _loc5_:Array = new Array(param3);
         this.m_raycastSegment = param1;
         this.m_raycastUserData = param4;
         var _loc6_:int = this.m_broadPhase.QuerySegment(param1,_loc5_,param3,this.RaycastSortKey);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            param2[_loc7_] = _loc5_[_loc7_];
            _loc7_++;
         }
         return _loc6_;
      }
      
      public function RaycastOne(param1:b2Segment, param2:Array, param3:b2Vec2, param4:*) : b2Shape
      {
         var _loc5_:Array = new Array(1);
         var _loc6_:Number = this.Raycast(param1,_loc5_,1,param4);
         if(_loc6_ == 0)
         {
            return null;
         }
         ...
         var _loc7_:b2Shape = _loc5_[0];
         var _loc8_:b2XForm = _loc7_.GetBody().GetXForm();
         _loc7_.TestSegment(_loc8_,param2,param3,param1,1);
         return _loc7_;
      }
      ...
      public function RaycastSortKey(param1:b2Shape) : *
      {
         if(Boolean(this.m_contactFilter) && !this.m_contactFilter.RayCollide(this.m_raycastUserData,param1))
         {
            return -1;
         }
         ...
         var _loc4_:Array = [0];
         if(!param1.TestSegment(_loc3_,_loc4_,this.m_raycastNormal,this.m_raycastSegment,1))
         {
            return -1;
         }
         return _loc4_[0];
