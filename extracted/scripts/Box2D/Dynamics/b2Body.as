package Box2D.Dynamics
{
   ...
   public class b2Body
   {
      ...
      {
         return new b2Vec2(this.m_linearVelocity.x + this.m_angularVelocity * (param1.y - this.m_sweep.c.y),this.m_linearVelocity.x - this.m_angularVelocity * (param1.x - this.m_sweep.c.x));
      }
