...
// TS engine and asserts hex16(ours) === golden for ComputeMass (mass/centre/inertia),
// the polygon centroid, OBB (centre/extents/R), the TOI-slop core vertices, and the
// edge normals. All quantities are +-*/ and sqrt (no trig) so this is a PURE bit-exact
// gate — the load-bearing mass/inertia path that feeds invMass/invI/localCenter.
