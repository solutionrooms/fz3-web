// m3b — contact lifecycle bit-exact gate.
//
...
// PairAdded/PairRemoved + RefilterProxy round-trip.
...
function makeWorld(): b2World {
  ...
  return new b2World(aabb, new b2Vec2(0, 6), true);
}
...
describe("m3b — contact lifecycle (bit-exact)", () => {
